...
public class Home implements Handler {
    ...
    public void handle(Context context) throws Exception {
        ...
        html = html + "<a href='/infectionsbycountry.html'><i>Find out more about case numbers and other trends in my country.</i></a><br>";
        html = html + "<a href='/comparecountries.html'><i>Detailed reports and graphs with a wide range of countries.</i></a><br>";
        html = html + "<a href='/'>Safe practices to reduce the risk of transmission</a><br>";
        html = html + "<a href='/reports.html'>Statistical Analysis</a>";
